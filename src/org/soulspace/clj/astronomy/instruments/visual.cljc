...
(defn ocular-focal-length
  "Calculates the required focal length of an ocular for the given aperture
   and focal-length of an objective and exit pupil."
...
(defn field-of-view
  ...
  (* ocular-field-of-view (/ ocular-focal-length
